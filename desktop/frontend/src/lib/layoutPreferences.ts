...
const STORAGE_KEY = "gaeaW.layoutPreferences.v1";

const LEGACY_SIZE_KEYS: Record<LayoutSizeKey, string[]> = {
  sidebarWidth: ["gaeaW.sidebar.width"],
  workspacePanelWidth: ["gaeaW.workspacePanel.width"],
  workspaceFileTreePanelWidth: [],
  workspaceTreeWidth: ["gaeaW.workspaceTree.width"],
  composerHeight: ["gaeaW.composerHeight"],
  drawerWidth: ["gaeaW.drawer.width"],
  settingsDrawerWidth: ["gaeaW.settingsDrawer.width"],
};
