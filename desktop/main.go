// Command gaeaW-desktop is the Wails shell around the Tianxuan kernel: a native
...
// a nested module (gaeaW/desktop) so the CGO/WebKit desktop build never touches
...
// mirroring cmd/gaeaW/main.go. The auto-updater reads it (App.Version) to compare
