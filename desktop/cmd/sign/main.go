...
// (gaeaW.key) and the public key (gaeaW.pub) into dir. The password comes
...
func genKey(dir string) error {
	...
	keyPath := filepath.Join(dir, "gaeaW.key")
	pubPath := filepath.Join(dir, "gaeaW.pub")
