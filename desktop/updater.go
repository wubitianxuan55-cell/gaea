...
const (
	...
	manifestFallback    = "https://github.com/esengine/gaeaW/releases/latest/download/latest.json"
	defaultDownloadPage = "https://github.com/esengine/gaeaW/releases/latest"
