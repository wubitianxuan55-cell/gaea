...
func TestWithAttachmentRefs(t *testing.T) {
	attachments := []chatAttachment{
		{Path: ".gaeaW/attachments/clipboard-20260601-010203.000001.png"},
		{Path: ".gaeaW/attachments/clipboard-20260601-010204.000002.jpg"},
	}
	got := withAttachmentRefs("describe", attachments)
	want := "describe @.gaeaW/attachments/clipboard-20260601-010203.000001.png @.gaeaW/attachments/clipboard-20260601-010204.000002.jpg"
	if got != want {
...
func TestDisplayLineForImageRefs(t *testing.T) {
	got := displayLineForImageRefs("describe @.gaeaW/attachments/clipboard-20260601-010203.000001.png @.gaeaW/attachments/clipboard-20260601-010204.000002-000002.jpg")
