...
// than shipped in the gaeaW binary, which keeps installs small. Resolve finds
...
// BundleDirName is the directory, beside the gaeaW executable, that the release
...
//  4. a bundle placed beside the gaeaW executable (fallback for manual setups).
//
...
// bundled looks for the CodeGraph launcher unpacked beside the gaeaW binary.
