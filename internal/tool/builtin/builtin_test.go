...
func TestEditFile(t *testing.T) {
	...
	runTool(t, editFile{}, map[string]any{"path": f, "old_string": "world", "new_string": "gaeaW"})
	if b, _ := os.ReadFile(f); string(b) != "hello gaeaW\n" {
...
func TestMultiEdit(t *testing.T) {
	...
	out := runTool(t, multiEdit{}, map[string]any{
		...
		"edits": []map[string]any{
			...
			{"old_string": "old", "new_string": "gaeaW", "replace_all": true},
		},
	})
