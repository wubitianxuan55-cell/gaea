...
// `gaeaW chat --resume` to load a saved JSONL transcript before the first turn,
...
// (Design adopted from DeepSeek-Reasonix-V1.12, simplified for gaeaW)
