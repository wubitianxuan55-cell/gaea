...
func (e *AuthError) Error() string {
	...
	return fmt.Sprintf("authentication failed for provider %q (HTTP %d): %s is invalid or expired 鈥?update it (in .env or your environment) and retry, or run `gaeaW setup`",
